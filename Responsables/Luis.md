...
**Memoria de cálculo del cableado — la corrección más importante que vas a defender**: la primera versión del presupuesto estimaba "6 cajas" de cable UTP al ojo, un número irreal para 184 usuarios. Se rehizo con metodología explícita: 405 puntos de red (184 usuarios × 2 salidas + margen) × 45m promedio por corrida ÷ 305m por caja = **66 cajas** — subió el presupuesto de producción de ~Q32,300 a ~Q88,765, pero es la cifra real de cablear 4 pisos, no una estimación optimista. Detalle completo en doc. 04 §8, que es la misma memoria de cálculo que sostiene tu [08-Equipo-Fisico-Presupuesto.md](../00-Documentacion-General/08-Equipo-Fisico-Presupuesto.md) §4.
...
3. Confirmar con Melany y Jeferson que tu memoria de cálculo (405 puntos, 66 cajas) sigue cuadrando con lo que ellos definieron en sus puntos.
